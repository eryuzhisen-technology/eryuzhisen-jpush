package com.eryuzhisen.jpush.example;
...
public class PushExample {
	...
	private static final String appKey = "e1a292435c2e1f2a358c8474"; // 正式
	// private static final String masterSecret = "e8cc9a76d5b7a580859bcfa7";
	private static final String masterSecret = "ad03107149c813a715d79822";
	// //正式
	...
	public static void testSendIosAlert() {
		...
		IosAlert alert = IosAlert
				.newBuilder()
				.setTitleAndBody("test alert", "subtitle",
						"test ios alert json").setActionLocKey("PLAY").build();
		try {
